...
public class VentanaJuegoGanador extends JFrame {
	...
	public VentanaJuegoGanador() {
		...
		TwitterButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					RRSS.compartirTwitter(res.getString("nombreUsuario"), res.getInt("puntos"),res.getInt("numPremios"), res.getInt("puntosHistoricos"));
		...
		//COMPARTIR FACEBOOK
		ImageIcon WhatsAppButtonIcon = new ImageIcon(VentanaJuegoGanador.class.getResource("/packImages/whatsapp.png"));
		Image img3 = WhatsAppButtonIcon.getImage();
		...
		WhatsAppButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					res=BattleShip.obtDatos();
					RRSS.compartirWhatsApp(res.getString("nombreUsuario"), res.getInt("puntos"),res.getInt("numPremios"), res.getInt("puntosHistoricos"));
				} catch (IOException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				} catch (URISyntaxException e1) {
		...
		//COMPARTIR REDDIT
		ImageIcon RedditButtonIcon = new ImageIcon(VentanaJuegoGanador.class.getResource("/packImages/reddit.png"));
		...
		RedditButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					res=BattleShip.obtDatos();
					RRSS.compartirReddit(res.getString("nombreUsuario"), res.getInt("puntos"),res.getInt("numPremios"), res.getInt("puntosHistoricos"));
				} catch (IOException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				} catch (URISyntaxException e1) {
