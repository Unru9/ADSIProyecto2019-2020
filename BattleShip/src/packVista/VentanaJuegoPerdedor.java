	...
	public VentanaJuegoPerdedor() {
		...
		WhatsAppButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					res=BattleShip.obtDatos();
					RRSS.compartirWhatsApp(res.getString("nombreUsuario"), res.getInt("puntos"),2, res.getInt("puntosHistoricos"));
				} catch (IOException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				} catch (URISyntaxException e1) {
		...
		RedditButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					res=BattleShip.obtDatos();
					RRSS.compartirReddit(res.getString("nombreUsuario"), res.getInt("puntos"),1, res.getInt("puntosHistoricos"));
				} catch (IOException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				} catch (URISyntaxException e1) {
